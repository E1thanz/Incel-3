...
INSTRUCTIONS = {"add": ((3, 4),
                ...
                "rti": ((2,),
                        ("10001", PARAMETERS.Register, "00000", lambda value, line, instruction: PARAMETERS.Immediate(value, 3, line, instruction))),
                "ani": ((2,),
                ...
                "ldi": ((2,),
                        ("10111", PARAMETERS.Register, lambda value, line, instruction: PARAMETERS.Immediate(value, 8, line, instruction))),
                "pst": ((2,),
                        ("11000", PARAMETERS.Register, "000", lambda value, line, instruction: PARAMETERS.Immediate(value, 5, line, instruction))),
                "pld": ((2,),
                        ("11001", PARAMETERS.Register, "000", lambda value, line, instruction: PARAMETERS.Immediate(value, 5, line, instruction)))
                }
